      ...
      <section className="create-event-cont">
        <div className="left-event">
          ...
          <div className="location-event">      
            <div>      
              <label htmlFor="country" className="loc">Country*</label><br></br>
            ...
            <div>
              <label htmlFor="country" className="loc">State*</label><br></br>
              <select name="country" className="country">
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
                <option value="Albania">Albania</option>
          ...
          <h5 className="below-input">
            Tags help users to find your event. You can use upto 8 tags.
          </h5>   
        ...
        <div className="right-event">
          <div className="top-inline">
            ...
            <i
              ...
              onClick={deleteImage}
            ></i>
            <span>This image will be displayed on event page. Recommended size 500x500px</span>
          </div>
          <div
