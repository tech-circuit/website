  ...
  return (
    <main style={{ position: "relative" }}>
            ...
            <p data-aos="fade-right" data-aos-delay="300">
              ...
              <i>
                <span style={{ fontWeight: "600" }}>
                  community of high school and college students
                </span>
              </i>{" "}
      ...
      <section className="feats">
        <div className="clubs container">
          <div className="club-left">
            ...
            <p data-aos="fade-right" data-aos-delay="400">
              The biggest clubs in the Indian Tech Circuit, including Exun, CW, TS and many more are a part of techCircuit and have been involved in building this project.
            </p>
          </div>
        ...
        <div className="feat container">
          <div className="feat-banner">
            <img className="feat-img-minus" src="/assets/land4.svg" alt="alt" />
          </div>
          <div className="feat-content">
            <h2 data-aos="fade-left">
        ...
        <div className="feat last-feat container">
          ...
          <div className="feat-banner">
            <img className="feat-img-plus" src="/assets/land6.svg" alt="alt" />
          </div>
        </div>
      </section>
