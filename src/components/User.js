            ...
            <section className="user-cont">
                ...
                <div className="user-div aboutme">
                    ...
                    <p>
                        ...
                        Sed scelerisque pellentesque mauris at accumsan. Nullam
                        nec pulvinar ante. Quisque sed risus quis elit pretium
                        sollicitudin.
                    </p>
                </div>
                <div className="user-div skills">
                    <h3>Skills</h3>
                    <p>UI/UX, Illustration, interface design, 3D Design</p>
                </div>
